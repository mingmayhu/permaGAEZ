...
BASEPATH    = r'./data_input/qilian_mask_new.tif'
...
if __name__ == '__main__':
    ...
    for year in YEARS:
        combine_crop_maps(year, varieties, output_tag='combined_spring_oat_NEW')
    plot_final_classification("combined_spring_oat_NEW")